...
const productFields = (includeKind: boolean): Field[] => [
  ...
  { key: "measurements", label: "Medidas do produto", type: "text", half: true, help: "ex.: 20 x 15 x 8 cm, 500 ml, P/M/G" },
  { key: "package_use", label: "Para que serve", type: "textarea", help: "Explique a finalidade da embalagem/produto e como ele deve ser usado." },
  { key: "compatible_product_types", label: "Combina com quais produtos", type: "array", help: "Um por linha. ex.: doces finos, vinhos, cosméticos, flores" },
  { key: "special_occasions", label: "Momentos especiais", type: "array", help: "Um por linha. ex.: casamento, maternidade, corporativo, aniversário" },
...
export const entities: Record<string, Entity> = {
  fornecedores: {
    ...
    fields: [
      ...
      { key: "product_measurements", label: "Medidas fornecidas", type: "text", half: true, help: "ex.: caixas 20 x 15 x 8 cm, fitas 10 mm, tags 5 x 9 cm" },
      { key: "packaging_use", label: "Para que serve", type: "textarea", help: "Descreva a utilidade das embalagens ou produtos desse fornecedor." },
      { key: "compatible_product_types", label: "Combina com produtos", type: "array", help: "Um por linha. ex.: bebidas, doces, flores, cosméticos" },
      { key: "special_occasions", label: "Momentos especiais", type: "array", help: "Um por linha. ex.: casamento, natal, corporativo, maternidade" },
